...
//             response.data.user_type !== "recruteur")
//         ) {
//           clearSession();
...
//     try {
//       const response = await axios.post(
//         "http://127.0.0.1:8000/api/reset-password-with-code/",
//         {
//           token: resetToken,
//           email: resetEmailTemp,
//           new_password: newPassword,
...
//               <div
//                 style={
//                   resetMessageType === "success" ? successStyle : errorStyle
//                 }
//               >
//                 {resetMessage}
//               </div>
